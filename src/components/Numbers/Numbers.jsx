    ...
    return (
        <div className='section'>
            ...
            <div className='check_cont'>
                ...
                >No Double!</button>
                <div onClick={undo} className='undo'>UNDO</div>
            ...
            <div className='static'>
                ...
                <div className='two_columns'>
                    <div className='big_double'>
                        <p>Checkouts</p>
                        <div className='data'>{checkOuts.filter(el => el.checkOut === 1).map(el => el.item).join(', ')}</div>
                    </div>
                    <div className='big_double'>
                        <p>100+</p>
            ...
            <a href="mailto:andreipopkov353@gmail.com">Write a review about the application</a>
        </div>
    )
}
